...
static const char soap_env2[40] = "http://www.w3.org/2003/05/soapenvelope";
...
http_response(struct soap *soap, int status, ULONG64 count)
{
  ...
  else if (status < 200 || status >= 600)
  {
    ...
    if (status >= SOAP_GET_METHOD && status <= SOAP_HTTP_METHOD)
      code = 405;
    else if (soap->version == 2 && (!s || !strcmp(s, "soapenv:Sender")))
      code = 400;
    else
      code = 500;
  }
...
soap_element(struct soap *soap, const char *tag, int id, const char *type)
{
  ...
  if (soap->mustUnderstand)
  {
    ...
    {
      if (soap_attribute(soap, soap->version == 2 ? "soapenv:role" : "soapenv:actor", soap->actor))
        return soap->error;
    }
    if (soap_attribute(soap, "soapenv:mustUnderstand", soap->version == 2 ? "true" : "1"))
      return soap->error;
    soap->mustUnderstand = 0;
  }
  if (soap->encoding)
  {
    if (soap->encodingStyle && soap->local_namespaces && soap->local_namespaces[0].id && soap->local_namespaces[1].id)
    {
      ...
      if (soap->encodingStyle && soap_attribute(soap, "soapenv:encodingStyle", soap->encodingStyle))
        return soap->error;
    }
    else
    {
  ...
  *s = '\0';
  ...
  for (tp = soap->attributes; tp; tp = tp->next)
  {
    if (tp->visible && tp->value)
    {
      ...
      else if (!soap_match_tag(soap, tp->name, "soapenv:encodingStyle"))
      {
        if (!soap->encodingStyle)
          soap->encodingStyle = SOAP_STR_EOS;
        soap_version(soap);
      ...
      else if (soap->version == 1)
      {
        ...
        else if (!soap_match_tag(soap, tp->name, "soapenv:mustUnderstand")
              && (!strcmp(tp->value, "1") || !strcmp(tp->value, "true")))
        {
          soap->mustUnderstand = 1;
        }
        else if (!soap_match_tag(soap, tp->name, "soapenv:actor"))
        {
      ...
      else if (soap->version == 2)
      {
        ...
        else if (!soap_match_tag(soap, tp->name, "soapenv:role"))
        {
          if ((!soap->actor || strcmp(soap->actor, tp->value))
           && strcmp(tp->value, "http://www.w3.org/2003/05/soapenvelope/role/next"))
            soap->other = 1;
        }
      }
      else
...
soap_select_mime_boundary(struct soap *soap)
{
  ...
  if (!soap->mime.start)
    soap->mime.start = "<soapenv:Envelope>";
}
#endif
#endif
...
soap_envelope_begin_out(struct soap *soap)
{
  ...
  return soap_element_begin_out(soap, "soapenv:Envelope", 0, NULL);
}
#endif
...
soap_envelope_end_out(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  if (soap_element_end_out(soap, "soapenv:Envelope")
   || soap_send_raw(soap, "\r\n", 2))   /* 2.8: always emit \r\n */
    return soap->error;
#ifndef WITH_LEANER
...
{
  soap->part = SOAP_IN_ENVELOPE;
  if (soap_element_begin_in(soap, "soapenv:Envelope", 0, NULL))
  {
...
soap_envelope_end_in(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  soap->part = SOAP_END_ENVELOPE;
  return soap_element_end_in(soap, "soapenv:Envelope");
}
#endif
...
soap_body_begin_out(struct soap *soap)
{
  ...
  return soap_element_begin_out(soap, "soapenv:Body", 0, NULL);
}
#endif
...
soap_body_end_out(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  if (soap_element_end_out(soap, "soapenv:Body"))
    return soap->error;
...
soap_body_begin_in(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  soap->part = SOAP_IN_BODY;
  if (soap_element_begin_in(soap, "soapenv:Body", 0, NULL))
    return soap->error;
  if (!soap->body)
...
soap_body_end_in(struct soap *soap)
{
  ...
  if (soap->part == SOAP_NO_BODY)
    return soap->error = SOAP_OK;
  soap->part = SOAP_END_BODY;
  return soap_element_end_in(soap, "soapenv:Body");
}
#endif
...
soap_recv_fault(struct soap *soap, int check)
{
  ...
  if (soap_getfault(soap))
  {
    ...
    *soap_faultcode(soap) = (soap->version == 2 ? "soapenv:Sender" : "soapenv:Client");
    if (status)
      soap->error = status;
    else
  ...
  {
    const char *s = *soap_faultcode(soap);
    if (!soap_match_tag(soap, s, "soapenv:Server")
     || !soap_match_tag(soap, s, "soapenv:Receiver"))
    {
      status = SOAP_SVR_FAULT;
    }
    else if (!soap_match_tag(soap, s, "soapenv:Client")
          || !soap_match_tag(soap, s, "soapenv:Sender"))
    {
      status = SOAP_CLI_FAULT;
    }
    else if (!soap_match_tag(soap, s, "soapenv:MustUnderstand"))
    {
      status = SOAP_MUSTUNDERSTAND;
    }
    else if (!soap_match_tag(soap, s, "soapenv:VersionMismatch"))
    {
...
{
  return soap_set_error(soap, soap->version == 2 ? "soapenv:Sender" : soap->version == 1 ? "soapenv:Client" : "at sender", NULL, faultstring, faultdetailXML, soaperror);
}
#endif
...
{
  return soap_set_error(soap, soap->version == 2 ? "soapenv:Receiver" : soap->version == 1 ? "soapenv:Server" : "detected", NULL, faultstring, faultdetailXML, soaperror);
}
#endif
...
{
  return soap_copy_fault(soap, soap->version == 2 ? "soapenv:Sender" : soap->version == 1 ? "soapenv:Client" : "at source", faultsubcodeQName, faultstring, faultdetailXML);
}
#endif
...
{
  return soap_copy_fault(soap, soap->version == 2 ? "soapenv:Receiver" : soap->version == 1 ? "soapenv:Server" : "is internal", faultsubcodeQName, faultstring, faultdetailXML);
}
#endif
